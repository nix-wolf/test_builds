...
type
  TuNetworkDispatcher = class
    ...
    public
      ...
      procedure SetupHandler(aFlag: TuPacketFlag; aProtocol: TuNetProtocol;
      ...
      procedure Register(aFlag: TuPacketFlag; aProto: TuNetProtocol;
        aRoles: TArray<TuNetworkRole>; aRoutines: TArray<TuPacketRoutine>);
  end;
...
procedure TuNetworkDispatcher.Register(aFlag: TuPacketFlag;
  aProto: TuNetProtocol; aRoles: TArray<TuNetworkRole>;
...
procedure TuNetworkDispatcher.SetupHandler(aFlag: TuPacketFlag;
  aProtocol: TuNetProtocol; aHandler: TuPacketHandler);
begin
  FHandlers.AddOrSetValue(TuDispatchKey.Create(aFlag, aProtocol), aHandler);
end;

procedure TuNetworkDispatcher.SetupUHandler(aFlag: TuPacketFlag;
  aHandler: TuPacketHandler);
begin
