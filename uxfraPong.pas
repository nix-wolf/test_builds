...
procedure TxfrmPong.FrameKeyDown(Sender: TObject; var Key: Word; var KeyChar: Char;
  Shift: TShiftState);
begin
...
procedure TxfrmPong.FrameKeyUp(Sender: TObject; var Key: Word; var KeyChar: Char;
  Shift: TShiftState);
begin
...
procedure TxfrmPong.FrameMouseDown(Sender: TObject; Button: TMouseButton;
...
begin
  ...
  if recPlayer1.Position.Y < aBottomCheck then recPlayer1.Position.Y := aBottomCheck;
